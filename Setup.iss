...
AppId={{AD9789B8-5392-45D1-8A66-88171F632C09}
AppName={#MyAppName}
...
OutputBaseFilename=Moligeek Setup.exe
...
Source: "C:\Users\CoolPlayLin\OneDrive\桌面\Git\MoliGeek-Installer\Source\dist\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
